...
DO $$ BEGIN
  CREATE TYPE "UserRole" AS ENUM ('SUPER_ADMIN', 'REQUESTER', 'VERTICAL_OWNER', 'FUNCTIONAL_HEAD', 'L1_APPROVER', 'FINANCE_APPROVER', 'CFO', 'CDO', 'PRODUCTION');
EXCEPTION WHEN duplicate_object THEN NULL; END $$;
DO $$ BEGIN
  CREATE TYPE "TeamName" AS ENUM ('INNOVATION', 'ENGINEERING', 'SALES', 'DEPLOYMENT');
EXCEPTION WHEN duplicate_object THEN NULL; END $$;
DO $$ BEGIN
...
CREATE TABLE IF NOT EXISTS tickets (
  ...
  l1_manager_id UUID REFERENCES users(id) ON DELETE SET NULL,
  rejected_by_name TEXT,
  rejected_by_email TEXT,
  rejected_at TIMESTAMPTZ,
  rejected_stage TEXT,
  urgent_reminder_due_at TIMESTAMPTZ,
