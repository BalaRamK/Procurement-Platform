    ...
    <div className="relative">
      ...
      {open && (
        <>
          ...
          <div id="notification-dropdown" className="absolute right-0 top-full z-50 mt-2 w-80 overflow-hidden rounded-2xl border border-white/25 bg-white/95 shadow-xl backdrop-blur-xl dark:border-white/10 dark:bg-slate-900/95">
            ...
            <div className="max-h-80 overflow-y-auto">
              {loading ? (
                ...
                <div className="px-4 py-8 text-center">
                  ...
                  <p className="mt-1 text-xs text-slate-400 dark:text-slate-500">No new notifications.</p>
                </div>
              ) : (
                list.map((n) => (
                  <Link
