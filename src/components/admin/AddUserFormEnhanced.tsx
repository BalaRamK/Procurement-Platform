  ...
  return (
    <form onSubmit={handleSubmit} className="grid max-w-5xl gap-6 xl:grid-cols-[minmax(0,1fr)_320px]">
      <div className="space-y-6">
        ...
        <SectionCard title="Roles and routing" description="Assign one or more roles. Vertical is needed for requester, Vertical Owner, and department-based approval roles.">
          <div className="grid gap-3 md:grid-cols-2">
            {roles.map((role) => {
