...
const STATUS_STYLES: Record<string, string> = {
  ...
  PENDING_FINANCE_APPROVAL: "bg-amber-400/20 text-amber-800 border-amber-400/30 dark:bg-amber-500/25 dark:text-amber-200 dark:border-amber-400/40",
  ...
  ORDER_PLACED: "bg-indigo-400/20 text-indigo-800 border-indigo-400/30 dark:bg-indigo-500/25 dark:text-indigo-200 dark:border-indigo-400/40",
